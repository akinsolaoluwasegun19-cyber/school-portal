    ...
    <html lang="en">
      <body className={`${inter.className} overflow-x-hidden bg-gray-50`}>
        <div className="flex min-h-screen">
          ...
          {/* Sidebar - same green as your first image */}
          <aside className={`
          ...
          `}>
            ...
            <nav className="space-y-2">
              ...
              <a href="/payment" className="block p-2 rounded bg-white text-green-600 font-semibold">Payment Info</a>
          ...
          {/* Main content - light background like first image */}
